...
class DepartmentMapper
  ...
  ABBR_TO_HASH = {
    :"AGO"                 => { :name => "Attorney Generals Office",                          :css_class => "attorney-generals-office",                         :css_logo_suffix => "single-identity" },
    :"CO"                  => { :name => "Cabinet Office",                                    :css_class => "cabinet-office",                                   :css_logo_suffix => "single-identity" },
    :"BIS"                 => { :name => "Department for Business Innovation Skills",         :css_class => "department-for-business-innovation-skills",        :css_logo_suffix => "bis" },
    :"DCLG"                => { :name => "Department for Communities and Local Government",   :css_class => "department-for-communities-and-local-government",  :css_logo_suffix => "single-identity" },
    :"DCMS"                => { :name => "Department for Culture Media Sport",                :css_class => "department-for-culture-media-sport",               :css_logo_suffix => "single-identity" },
    :"DFE"                 => { :name => "Department for Education",                          :css_class => "department-for-education",                         :css_logo_suffix => "single-identity" },
    :"DEFRA"               => { :name => "Department for Environment Food Rural Affairs",     :css_class => "department-for-environment-food-rural-affairs",    :css_logo_suffix => "single-identity" },
    :"DFID"                => { :name => "Department for International Development",          :css_class => "department-for-international-development",         :css_logo_suffix => "single-identity" },
    :"DFT"                 => { :name => "Department for Transport",                          :css_class => "department-for-transport",                         :css_logo_suffix => "single-identity" },
    :"DWP"                 => { :name => "Department for Work Pensions",                      :css_class => "department-for-work-pensions",                     :css_logo_suffix => "single-identity" },
    :"DECC"                => { :name => "Department of Energy Climate Change",               :css_class => "department-of-energy-climate-change",              :css_logo_suffix => "single-identity" },
    :"DH"                  => { :name => "Department of Health",                              :css_class => "department-of-health",                             :css_logo_suffix => "single-identity" },
    :"FCO"                 => { :name => "Foreign Commonwealth Office",                       :css_class => "foreign-commonwealth-office",                      :css_logo_suffix => "single-identity" },
    :"HMT"                 => { :name => "HM Treasury",                                       :css_class => "hm-treasury",                                      :css_logo_suffix => "single-identity" },
    :"HOME OFFICE"         => { :name => "Home Office",                                       :css_class => "home-office",                                      :css_logo_suffix => "ho" },
    :"MOD"                 => { :name => "Ministry of Defence",                               :css_class => "ministry-of-defence",                              :css_logo_suffix => "mod" },
    :"MOJ"                 => { :name => "Ministry of Justice",                               :css_class => "ministry-of-justice",                              :css_logo_suffix => "single-identity" },
