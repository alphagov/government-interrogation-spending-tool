...
describe "DepartmentMapper" do
  describe "map_raw_to_css_hash" do
    it "takes a raw department reference and returns a hash with department abbr, name, css class, css logo suffix, colour, font_colour" do
      co_hash = { :abbr => "CO", :name => "Cabinet Office", :css_class => "cabinet-office", :css_logo_suffix => "single-identity", :colour=>"#0078ba", :font_colour=>"#fff"}
